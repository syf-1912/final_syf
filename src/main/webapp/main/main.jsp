...
<script type="text/javascript">
    $(function () {
        $.ajax({
            url: "${path}/menu/showAll",
            type: "post",
            dataType: "json",
            success: function (data) {
                $.each(data, function (index, menu) {
                    var c = "";
                    $.each(menu.childrens, function (index1, second) {
                        c += "<p style='text-align: center'><a href='javascript:void(0)' class='easyui-linkbutton' data-options=\"iconCls:'icon-search'\" onclick=\"addTabs('" + second.title + "','" + second.iconCls + "','" + second.href + "')\">" + second.title + "</a></p>";
                    });
